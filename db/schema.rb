...
ActiveRecord::Schema[7.0].define(version: 2023_06_14_194700) do
  ...
  create_table "reviews", force: :cascade do |t|
    t.float "rating"
    t.text "comment"
    t.bigint "trip_activity_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["trip_activity_id"], name: "index_reviews_on_trip_activity_id"
  end
